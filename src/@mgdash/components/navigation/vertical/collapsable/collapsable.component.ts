...
@Component({
    selector: "mgdash-nav-vertical-collapsable",
    templateUrl: "./collapsable.component.html",
    styleUrls: ["./collapsable.component.scss"],
    animations: mgdashAnimations,
})
export class MgdashNavVerticalCollapsableComponent
    ...
    ngOnInit(): void {
        ...
        this._mgdashNavigationService.onItemCollapsed
    ...
    toggleOpen(ev): void {
        ...
        this._mgdashNavigationService.onItemCollapsed.next(this.item);
        this._mgdashNavigationService.onItemCollapseToggled.next();
    }
