...
import { MatColors } from "@mgdash/mat-colors";
import { ControlValueAccessor, NG_VALUE_ACCESSOR } from "@angular/forms";

export const MGDASH_MATERIAL_COLOR_PICKER_VALUE_ACCESSOR: any = {
    provide: NG_VALUE_ACCESSOR,
    useExisting: forwardRef(() => MgdashMaterialColorPickerComponent),
    multi: true,
};

@Component({
    selector: "mgdash-material-color-picker",
    templateUrl: "./material-color-picker.component.html",
    styleUrls: ["./material-color-picker.component.scss"],
    animations: mgdashAnimations,
    encapsulation: ViewEncapsulation.None,
    providers: [MGDASH_MATERIAL_COLOR_PICKER_VALUE_ACCESSOR],
})
export class MgdashMaterialColorPickerComponent
    ...
    set color(value) {
        ...
        // Split the color value (red-400, blue-500, mgdash-navy-700 etc.)
    ...
    updateSelectedColor(): void {
        ...
        this.selectedColor = {
            ...
            bg:
                this.selectedPalette === ""
                    ? ""
                    : MatColors.getColor(this.selectedPalette)[
                          this.selectedHue
                      ],
            fg:
                this.selectedPalette === ""
                    ? ""
                    : MatColors.getColor(this.selectedPalette).contrast[
                          this.selectedHue
                      ],
        };
