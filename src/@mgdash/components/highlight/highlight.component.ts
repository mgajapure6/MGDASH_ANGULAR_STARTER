...
import "@mgdash/components/highlight/prism-languages";

@Component({
    selector: "mgdash-highlight",
    template: "",
    styleUrls: ["./highlight.component.scss"],
})
export class MgdashHighlightComponent implements OnInit, OnDestroy {
    // Source
    ...
    highlight(sourceCode): void {
        ...
        // can be formatted properly while using mgdash-highlight
        // component
