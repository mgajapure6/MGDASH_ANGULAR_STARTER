...
@Component({
    selector: "mgdash-shortcuts",
    templateUrl: "./shortcuts.component.html",
    styleUrls: ["./shortcuts.component.scss"],
})
export class MgdashShortcutsComponent
    ...
    ngOnInit(): void {
        ...
        this.filteredNavigationItems = this.navigationItems = this._mgdashNavigationService.getFlatNavigation(
            this.navigation
        );

        if (this._cookieService.check("MGDASH2.shortcuts")) {
            this.shortcutItems = JSON.parse(
                this._cookieService.get("MGDASH2.shortcuts")
            );
        } else {
