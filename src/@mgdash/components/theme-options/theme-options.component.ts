...
@Component({
    selector: "mgdash-theme-options",
    templateUrl: "./theme-options.component.html",
    styleUrls: ["./theme-options.component.scss"],
    encapsulation: ViewEncapsulation.None,
    animations: mgdashAnimations,
})
export class MgdashThemeOptionsComponent implements OnInit, OnDestroy {
    mgdashConfig: any;
    form: FormGroup;
    ...
    ngOnInit(): void {
        ...
        this.form.valueChanges
            ...
            .subscribe((config) => {
                // Update the config
                this._mgdashConfigService.config = config;
            });
        ...
        this._mgdashNavigationService.addNavigationItem(
    ...
    ngOnDestroy(): void {
        ...
        this._mgdashNavigationService.removeNavigationItem("custom-function");
    }
