...
import { MgdashSidebarService } from "./sidebar.service";
...
@Component({
    selector: "mgdash-sidebar",
    templateUrl: "./sidebar.component.html",
    styleUrls: ["./sidebar.component.scss"],
    encapsulation: ViewEncapsulation.None,
})
export class MgdashSidebarComponent implements OnInit, OnDestroy {
    // Name
    @Input()
    name: string;
    ...
    ngOnInit(): void {
        ...
        this._mgdashConfigService.config
            ...
            .subscribe((config) => {
                this._mgdashConfig = config;
            });

        // Register the sidebar
        this._mgdashSidebarService.register(this.name, this);
    ...
    ngOnDestroy(): void {
        ...
        this._mgdashSidebarService.unregister(this.name);
    ...
    private _showBackdrop(): void {
        ...
        this._backdrop.classList.add("mgdash-sidebar-overlay");

        // Add a class depending on the invisibleOverlay option
        if (this.invisibleOverlay) {
            this._backdrop.classList.add("mgdash-sidebar-overlay-invisible");
        }
