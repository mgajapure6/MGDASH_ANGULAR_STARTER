...
import {
    MgdashPerfectScrollbarGeometry,
    MgdashPerfectScrollbarPosition,
} from "@mgdash/directives/mgdash-perfect-scrollbar/mgdash-perfect-scrollbar.interfaces";
import { MgdashConfigService } from "@mgdash/services/config.service";

@Directive({
    selector: "[mgdashPerfectScrollbar]",
})
export class MgdashPerfectScrollbarDirective
     ...
     */
    @Input()
    set mgdashPerfectScrollbarOptions(value) {
        // Merge the options
    ...
    get mgdashPerfectScrollbarOptions(): any {
        // Return the options
    ...
    ngAfterViewInit(): void {
        ...
        if (this.mgdashPerfectScrollbarOptions.updateOnRouteChange) {
            this._router.events
                .pipe(
    ...
    _init(): void {
        ...
        this.ps = new PerfectScrollbar(this.elementRef.nativeElement, {
            ...this.mgdashPerfectScrollbarOptions,
        });
     ...
     * @param prefix
     */
    geometry(prefix: string = "scroll"): MgdashPerfectScrollbarGeometry {
        return new MgdashPerfectScrollbarGeometry(
     ...
     * @param absolute
     */
    position(absolute: boolean = false): MgdashPerfectScrollbarPosition {
        if (!absolute && this.ps) {
            return new MgdashPerfectScrollbarPosition(
                this.ps.reach.x || 0,
                this.ps.reach.y || 0
            );
        } else {
