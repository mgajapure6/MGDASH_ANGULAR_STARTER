...
export class MgdashInnerScrollDirective implements OnInit, OnDestroy {
    // Private
    private _parent: any;
     ...
     * @param {MgdashMatchMediaService} _mgdashMediaMatchService
     * @param {Renderer2} _renderer
     */
    constructor(
        private _elementRef: ElementRef,
        private _mgdashMediaMatchService: MgdashMatchMediaService,
    ...
    ngOnInit(): void {
        ...
        this._mgdashMediaMatchService.onMediaChange
